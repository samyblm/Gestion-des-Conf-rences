...
class SignIn extends Component {
    ...
    submitSignIn() {
        console.log('now running the submit sign in function')
...
//---------------------------------------------------------------------------------------------
    submitSignUp() {
        ...
        window.event.preventDefault()
        // console.log('now running the code of signup')
        ...
        return (
            <div className="flex-container">
                ...
                <div className="form__main" id="signIn">
                    ...
                    <form className="flex-container col hcenter" onSubmit={()=>this.submitSignIn()} onChange={()=>{document.getElementById('first-form-err').innerHTML=""}}>
                ...
                <div className="form__main" id="signUp">
                    ...
                    <form className="flex-container col hcenter" onSubmit={()=>this.submitSignUp()}>
                        ...
                        <div id="p1">
                            ...
                            <div className="input-field">
                                <input type="text" onFocus={() => document.getElementById('birthDate').setAttribute('type', 'date')} className="input-field__text" name="birthDate" id="birthDate" required placeholder="Date of birth" style={{ backgroundImage: 'url("/svgs/calendar2-date.svg")' }} />
                                <span className="form__err" id="birthDate-err"></span>
                            </div>
                            <div className="input-field">
                                <input type="texte" className="input-field__text" name="username" id="username" required placeholder="Username" style={{ backgroundImage: 'url("/svgs/person.svg")' }} />
